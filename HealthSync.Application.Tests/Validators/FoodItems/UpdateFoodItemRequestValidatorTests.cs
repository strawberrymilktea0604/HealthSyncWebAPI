...
public class UpdateFoodItemRequestValidatorTests
{
    private readonly UpdateFoodItemRequestValidator _validator;

    public UpdateFoodItemRequestValidatorTests()
    {
        _validator = new UpdateFoodItemRequestValidator();
    }
